...
const CreateContainerDiv = styled.div`
    ...
    width: 50%;
    border-top: ${props =>
        Boolean(props.hasBorderTop) ? "1px solid rgb(218,218,218)" : "none"};
...
export const CreateContent = props => (
    <ContainerDiv>
        ...
        <div style={{ fontSize: "1.2em", marginBottom: 40 }}>
            FOLLOW THESE EASY STEPS TO CALCULATE CATEGORIES, SUB-CATEGORIES, AND
            DIRECTORIES
        </div>
        <Link
            to={SYSTEM_CMS_CREATE_CONTENT_CATEGORY_URL}
        ...
        <Link
            to={SYSTEM_CMS_CREATE_CONTENT_SUBCATEGORY_URL}
            style={{ textDecoration: "none" }}
        >
            <CreateContainerDiv>
        ...
        <Link
            to={SYSTEM_CMS_CREATE_CONTENT_DIRECTORY_URL}
            style={{ textDecoration: "none" }}
        >
            <CreateContainerDiv>
        ...
        <Link
            ...
            style={{ textDecoration: "none" }}
        >
            {/*TODO: CHANGE URL FOR CREATE GALLERY PAGE*/}
            <CreateContainerDiv>
