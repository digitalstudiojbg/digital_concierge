...
// export const MainAdvertiserList = props => <div>ADVERTISER LIST</div>;

// export default MainAdvertiserList;
import React from "react";
...
class MainAdvertiserList extends React.Component {
    constructor(props) {
        super(props);
    ...
    modifyMainAdvertiserList = () => {
        // const { data } = this.props;
        this.props.data.map(({ id, active, name, agreement_number }) => ({
            id,
            active,
            ...
            <ContainerDiv>
                <TableDiv>
                    <MaterialTable
                        ...
                        data={this.modifyMainAdvertiserList()}
                        columns={[
                            { title: "CONTRACT#", field: "agreement_number" },
                            { title: "ADVERTISER", field: "name" },
                            {
                                title: "PUBLICATION",
                                field: "justBrilliantGuidedId.name"
                            },
                            { title: "TYPE/SIZE", field: "artworkSizeId" },
                            { title: "DISPLAY PERIOD", field: "period_month" },
                            {
...
export default withRouter(withStyles(styles)(MainAdvertiserList));
