...
class EditExistingArticle extends React.Component {
    tabs = [
        {
            name: "Preview",
            withButtons: true,
    ...
    constructor(props) {
        ...
        this.setToExitAfterSubmission = this.setToExitAfterSubmission.bind(
            this
        );
        this.exitAction = this.exitAction.bind(this);
    }

    setToExitAfterSubmission = callback => {
    ...
    exitAction = () => {
        ...
        history.push(GUIDE_MAIN_URL.replace(":pub_id", pub_id));
    };
